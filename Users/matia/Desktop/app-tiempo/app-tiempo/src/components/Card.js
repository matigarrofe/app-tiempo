            ...
            showData === true ? (
                ...
                <div className='card mb-3 mx-auto bg-dark text-light'>
                    <div className='row g-0'>
                        <div className='col-md-4 imgCard'>
                            <h3 className='card-title'>{weather.name}</h3>
                            <p className='card-date'>{date}</p>
                            <h1 className='card-temp'>{(weather.main.temp - 273.15).toFixed(1)}°C</h1>
                            <p className='card-desc'><img src={iconUrl} alt="icon"/>{weather.weather[0].description}</p>
                            <img src={city} id='imgCard' className='img-fluid rounded-start'  alt=".." />
                        </div>
                        <div className='col-md-8'>
                            <div className='card-body text-start mt-2'>
                                ...
                                <h5 className='card-text'>Húmedad: {(weather.main.humidity)}%</h5>
                            ...
                            <div className='row mt-4'>
                                ...
                                <div className="col">
                                    <p>{forecastDate6}h</p>
                                    <p className='description'><img src={iconUrl6} alt="icon"/>{forecast.list[1].weather[0].description}</p>
